...
# --- CONFIG ---
DATASET_DIR = r"D:\Github_Desktop\AI-Powered-Precision-Farming\Crop_Disease_Detection\CauliflowerLeaf\Cauliflower_dataset\Cauli_train"  # e.g., "D:/datasets/cauliflower"
IMAGE_SIZE = 224
BATCH_SIZE = 16
EPOCHS = 1
LR = 1e-4
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint('cauli_model.h5', save_best_only=True, monitor='val_accuracy', mode='max')
]
...
print("📊 Plots saved as 'training_curves.png'")
model.save('final_cauliflower_model.h5')
print("Model training complete. Saved as 'final_cauliflower_model.h5'")
